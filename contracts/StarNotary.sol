...
contract StarNotary is ERC721Metadata("Brian", "BRN") {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1Address || msg.sender == owner2Address, "The sender is not owner of tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId);
        require(msg.sender == ownerAddress, "The sender is not the owner");
